...
public class CodeGen3531 {
    ...
    public static void main(String[] args) {
       String[] tables={ "governance_metric","governance_type","governance_assess_detail"};
        ...
        FastAutoGenerator.create("jdbc:mysql://hadoop102:3306/demo","root","000000")
                .globalConfig(builder -> {
                    builder.author("zhangchen")               //作者
                            .outputDir("D:\\workspace\\workspace2023\\data-governance-assessment\\src\\main\\java")    //输出路径(写到java目录)
